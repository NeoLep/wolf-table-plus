...
export declare function rowHeight(data: TableData, index: number, value: number, autoWrap?: boolean): void;
...
export declare function getMaxRowIndexHasValue(data: TableData): number;
